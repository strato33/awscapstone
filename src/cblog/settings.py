...
DATABASES = {
    'default': {
        ...
        'HOST': 'database-1.cig9x4iazikv.us-east-1.rds.amazonaws.com',  # database endpoint is written here
        'PORT': '3306' # database port is written heree
    }
}
...
AWS_STORAGE_BUCKET_NAME = 'awscapstoneblogpage' # please enter your s3 bucket name
